 ...
 * 1. Business logic (ViewModels/Interactors) calls [updateErrorStatus], [updateInfoStatus],
 *    or [updateWarningStatus] to broadcast a new state.
...
interface StatusStateHolder {
     ...
     */
    fun updateErrorStatus(message: String)

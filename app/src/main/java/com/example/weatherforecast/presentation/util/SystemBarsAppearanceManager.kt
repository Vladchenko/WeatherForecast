package com.example.weatherforecast.presentation.util
 ...
 *
 * @param activity The activity for which system bar appearance is being managed.
 */
class SystemBarAppearanceManager(private val activity: Activity) {

...
interface HourlyWeatherRemoteDataSource {
    ...
    suspend fun loadHourlyWeatherForCity(city: String): Response<HourlyWeatherResponse>

    /**
     * Receive hourly weather forecast for a location defined by [latitude] and [longitude].
     */
    @InternalSerializationApi
    suspend fun loadHourlyWeatherForLocation(latitude: Double, longitude: Double): Response<HourlyWeatherResponse>
}
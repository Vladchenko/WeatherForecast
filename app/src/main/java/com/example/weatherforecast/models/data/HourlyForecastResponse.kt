 ...
 *
 * This class is used for local persistence via Room database. It holds a list of [HourlyForecastItem]
...
data class HourlyForecastResponse constructor(
    @PrimaryKey
    @SerializedName("city")
    val city: City,
    @SerializedName("list")
 ...
 *
 * Used as part of [HourlyForecastResponse] and serves as the primary key in the database.
 *
